                ...
                <form className="w-full max-w-[750px] lg:w-[750px] lg:max-w-full rounded-lg flex items-center justify-center xl:justify-start">
                    ...
                    <div className="md:px-4 py-5 bg-white flex flex-wrap items-center justify-center md:justify-between rounded-md shadow-[0px_0px_15px_rgba(0,0,0,0.09)]">
                        <div className="flex flex-col gap-2">
                            ...
                            {userData?.goals.map(goal => {
                                return (
                                    ...
                                    for={`${goal.title}`}
                                    name="goal"
                                    class="font-medium cursor-pointer h-14 relative hover:bg-zinc-100 flex items-center px-3 gap-3 rounded-lg has-[:checked]:text-blue-500 has-[:checked]:bg-blue-50 has-[:checked]:ring-blue-300 has-[:checked]:ring-1 select-none"
                                >
                                    <div class="w-5">
                                    {/* <PersonStanding /> */}
                        ...
                        <div className="flex items-center gap-2">
                            <input type="number" name="weight" value={userData?.weight} className="bg-gray-100 border text-gray-900 rounded-md p-2 mb-4 focus:bg-gray-200 focus:outline-none focus:ring-1 focus:ring-blue-500 transition ease-in-out duration-150" placeholder="Insira seu peso" />
                        ...
                        <div className="flex items-center gap-2">
                            <input type="number" name="height" value={userData?.height} className="bg-gray-100 border text-gray-900 rounded-md p-2 mb-4 focus:bg-gray-200 focus:outline-none focus:ring-1 focus:ring-blue-500 transition ease-in-out duration-150" placeholder="Insira sua altura" />
